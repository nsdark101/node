...
suite('quic internal endpoint stats and state', () => {
  test('endpoint state', () => {
    ...
    test('state can be inspected without errors', () => {
      strictEqual(typeof inspect(endpoint.state), 'string');
    });
  });

  test('state is not readable after close', () => {
    const endpoint = new Endpoint({
      onsession() {},
      session: {},
      stream: {},
  ...
  test('state constructor argument is ArrayBuffer', () => {
    const endpoint = new Endpoint({
      onsession() {},
      session: {},
      stream: {},
  ...
  test('endpoint stats', () => {
    ...
    test('stats can be inspected without errors', () => {
      strictEqual(typeof inspect(endpoint.stats), 'string');
    });
  });

  test('stats are still readble after close', () => {
    const endpoint = new Endpoint({
      onsession() {},
      session: {},
      stream: {},
  ...
  test('stats constructor argument is ArrayBuffer', () => {
    const endpoint = new Endpoint({
      onsession() {},
      session: {},
      stream: {},
  ...
  // implemented.
  test('stream and session states', () => {
    const streamState = new StreamState(new ArrayBuffer(1024));
  ...
  test('stream and session stats', () => {
    const streamStats = new StreamStats(new ArrayBuffer(1024));
